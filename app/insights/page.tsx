  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <section className="bg-slate-50 border border-slate-200 p-8 rounded-lg mb-12">
        ...
        <Link 
          href="/insights/divergence-rankings" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Link href="/insights/divergence-rankings" className="border p-6 rounded-lg hover:shadow-lg transition-shadow cursor-pointer">
          <h3 className="font-bold text-xl">Divergence Rankings</h3>
